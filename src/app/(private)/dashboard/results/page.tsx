...
//   // Normalize analysisResults to ensure id is always present and legalCompliance is a string
//   const normalizedResults = {
//     ...analysisResults,
//     risks: analysisResults.risks.map((risk, index) => ({
//       ...risk,
//       id: risk.id ?? `risk-${index}`,
//     })),
//     opportunities: analysisResults.opportunities.map((opp, index) => ({
//       ...opp,
//       id: opp.id ?? `opp-${index}`,
//     })),
//     legalCompliance: analysisResults.legalCompliance
//       ? analysisResults.legalCompliance.join("; ") // Convert string[] to string
//       : undefined, // Keep undefined if absent
//   };
