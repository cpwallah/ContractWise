...
//         `}</style>
//       </div>
//       <div className="w-full flex flex-col items-center relative z-20 px-4 sm:px-6 md:px-8 lg:px-12">
...
function PricingSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="w-full min-h-screen bg-gradient-to-br from-[#1A237E] via-[#1A237E]/80 to-[#FF6F61]/15 relative overflow-auto perspective-1000"
    >
      <div className="absolute inset-0 pointer-events-none z-0">
        {[...Array(60)].map((_, i) => (
          <span
