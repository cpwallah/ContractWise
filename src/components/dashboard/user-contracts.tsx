...
// import { Loader2, AlertCircle, FileText, AlertTriangle, Star, ChevronLeft, ChevronRight } from "lucide-react";
// import { useRouter } from "next/navigation";
// import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "../ui/select";

// export default function UserContracts() {
//   // Fetch user contracts using react-query
...
//       ),
//       cell: ({ row }) => (
//         <div>{row.getValue<string>("contractType") || "Unknown"}</div>
//       ),
//     },
//     {
...
//           </CardHeader>
//           <CardContent>
//             <div className={`text-2xl font-bold ${highRiskContracts > 0 ? "text-red-600" : "text-green-600"}`}>
//               {highRiskContracts}
//             </div>
//           </CardContent>
//         </Card>
...
//           <p className="mt-2 text-red-500">Error loading contracts: {(error as Error).message}</p>
//           <Button
//             variant="outline"
//             className="mt-4"
